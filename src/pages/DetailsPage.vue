  ...
  <div>
        ...
        <div class="row">
          ...
          >
            ...
            <div>
              ...
              <span class="text-h6">LKR 40199</span
              ><span
            ...
            <div class="q-mt-sm text-weight-bold">
              ...
              <ul class="q-pl-sm text-caption" style="list-style-type: none">
                <li class="q-mt-xs">
                  ...
                  Cashback on BOC Bank Credit Card
                  <a class="text-primary text-weight-bolder">T&C</a>
                </li>
                <li class="q-mt-xs">
                  <span class="text-weight-bold">Bank Offer</span> 5% Unlimited
                  Cashback on HNB Bank Credit Card
                  <a class="text-primary text-weight-bolder">T&C</a>
                </li>
                <li class="q-mt-xs">
          ...
          >
            ...
            <q-list dense bordered padding class="no-border q-mt-lg q-pr-xl">
              <q-item v-ripple style="padding-left: 0 !important">
    ...
    <div class="row q-mt-sm">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <q-tab-panels v-model="tab" style="border: 1px solid lightgrey">
  ...
  methods: {
    async fetchProductDetails() {
      const response = await axios.get(
        `http://localhost/ecommerce/product_details.php?id=${this.$route.params.id}`
      );
